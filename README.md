...
| Motorcycle-friendly road segments | 227 — every road draws its path, incl. the 1,079-mile Iron Butt Ride Around Maine loop | NER B-O-N-E + [OpenStreetMap](https://www.openstreetmap.org) via Overpass |
